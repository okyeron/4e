...
void MonomeSerial::processSerial() {
    ...
    uint8_t n, x, y, i, z, deviceAddress;
    ...
    uint8_t identifierSent = Serial.read();  
    ...
    switch (identifierSent) {
        case 0x00:  // device information
            ...
            Serial.write(0x02); // section id, 2 = key-grid, 5 = encoder/arc	## NEED devSect variable
        ...
        case 0x03:  // system / report size
            ...
            Serial.write(0x01);
            Serial.write(0x08);     // x offset - could be 0 or 8  ### NEEDS grid size variable
